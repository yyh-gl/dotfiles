...
ln -s "$HOME"/workspaces/github.com/yyh-gl/dotfiles/.claude/statusline.sh "$HOME"/.claude/statusline.sh
ln -s "$HOME"/workspaces/github.com/yyh-gl/dotfiles/.claude/keybindings.json "$HOME"/.claude/keybindings.json
