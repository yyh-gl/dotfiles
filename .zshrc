...
alias dot='cd $HOME/workspaces/github.com/yyh-gl/dotfiles'
alias ur='cd $HOME/workspaces/github.com/yyh-gl/urLogs'
alias my='cd $HOME/workspaces/github.com/yyh-gl/my-agent-teams'
